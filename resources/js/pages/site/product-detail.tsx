...
export default function ProductDetail({ product, heroImage, whatsapp, shareImage, shareUrl }: { product: Product; heroImage?: string | null; whatsapp?: string | null; shareImage?: string | null; shareUrl: string }) {
    const message = encodeURIComponent(`Gostaria de mais informações sobre ${product.title}\n${shareUrl}`);
    return <SiteLayout>
        <Head title={`${product.title} | Eplus`}>
            <meta name="description" content={product.summary || product.title}/>
            <meta property="og:type" content="product"/>
            <meta property="og:site_name" content="Eplus"/>
            <meta property="og:title" content={`${product.title} | Eplus`}/>
            <meta property="og:description" content={product.summary || product.title}/>
            <meta property="og:url" content={shareUrl}/>
            {shareImage && <meta property="og:image" content={shareImage}/>}
            {shareImage && <meta property="og:image:alt" content={product.title}/>}
        </Head>
